...
class Pengeluaran extends BaseController
{
    ...
    public function index(){
        ...
        $results = $this->Pengeluaranmodel->orderby('tgl','asc')->where('tgl >=',$start_date)->where('tgl <=',$end_date)->findAll();
        $data = array(
            'results'=>$results,
            'start'=>$start_date,
            'end'=>$end_date
        ...
        if(session('userlevel')!=0){
            return view('main/pengeluaran',$data);
        }else{
    ...
    public function delete(){
        ...
        if($id){
            $delete = $this->Pengeluaranmodel->where('id_transaksi',$id)->delete();
            if($delete){
                //delete jurnal 
    ...
    public function print(){
        ...
        if(session('userlevel')!=0){
            return view('print/pengeluaran',$data);
        }else{
            return view('member/profile',$data);
        }
    }
