                                                            ...
                                                            <div class="card">
																...
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																		...
																		<input class="form-control form-control-solid" placeholder="" name="nama" value="<?php echo $detail->nama;?> ( <?php echo $detail->no_anggota;?> )" id="nama" readonly/>
																	</div>
																	<div class="col-md-6 fv-row">
																...
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2">Nama Pinjaman</label>
																		<input class="form-control form-control-solid" placeholder="" name="nama_pinjaman" value="<?php echo $detail->nama_simpanan;?>" id="nama_pinjaman" readonly/>
																	</div>
																	<div class="col-md-6 fv-row">
																		...
																		?>
																		<input class="form-control form-control-solid" placeholder="" name="total_bunga" value="<?php echo number_format($totalbunga_idr);?>" id="total_bunga" readonly/>
																	</div>
																</div>
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2">Tgl Pengajuan</label>
																		<input class="form-control form-control-solid" placeholder="" name="tgl_pengajuan" value="<?php echo $detail->tgl_pengajuan;?>" id="tgl_pengajuan" readonly/>
																	</div>
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2">Angsuran Pokok</label>
																		<input class="form-control form-control-solid" placeholder="" name="angsuran_pokok" value="<?php echo number_format($pokok);?>" id="angsuran_pokok" readonly/>
																	</div>
																</div>
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2">Jumlah Pengajuan</label>
																		<input class="form-control form-control-solid" placeholder="" name="jumlah_pengajuan" value="<?php echo number_format($detail->jumlah);?>" id="jumlah_pengajuan" readonly/>
																	</div>
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2">Angsuran Bunga</label>
																		<input class="form-control form-control-solid" placeholder="" name="bunga_angsuran" value="<?php echo number_format($bunga_angsuran);?>" id="bunga_angsuran" readonly/>
																	</div>
																</div>
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																	...
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2">Jumlah Angsuran</label>
																		<input class="form-control form-control-solid" placeholder="" name="jumlah_angsuran" value="<?php echo number_format($total_angsuran);?>" id="total_angsuran" readonly/>
																	</div>
																</div>
																<hr/>
																<div class="row mb-5">
																...
																<div class="row mb-5">
																	...
																	?>
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2"><?php echo $row['nama_biaya'];?> (Rp)</label>
																		<input class="form-control form-control-solid" placeholder="" name="jumlah_biaya[]" value="<?php echo number_format($biaya);?>" readonly/>
																	</div>
																	<?php }?>
																</div>
																<hr/>
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																		<label class="fs-5 fw-semibold mb-2"><b>Total Biaya (Rp)</b></label>
																		<input class="form-control form-control-solid" placeholder="" name="total_biaya" value="<?php echo number_format($total_biaya);?>" id="total_biaya" readonly/>
																	</div>
																	<div class="col-md-6 fv-row">
																		<?php 
																			$total_pencairan = $detail->jumlah-$total_biaya;
																		?>
																		<label class="fs-5 fw-semibold mb-2"><b>Total Pencairan</b></label>
																		<input class="form-control form-control-solid" placeholder="" name="total_pencairan" value="<?php echo number_format($total_pencairan);?>" id="total_pencairan" readonly/>
																	</div>
																</div>
																<div class="row mb-12">
																<img src="<?php echo $detail->bukti_pembayaran;?>" width="100%">
																<table width="100%" align="center" cellpadding="5" cellspacing="0">
                                                                        ...
                                                                        <?php 
																			...
																			//$n = date('Y-m-d');
																			//$b =0;
                                                                            foreach($lastpinjaman as $angsuran){
                                                                                $no++;
																				if($angsuran->status){
																					$bg='#fff';
																				}else{
																...
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																			<a href="<?php echo site_url('terimapengajuan?id='.$id);?>" class="btn btn-primary btn-block btn-lg">Terima</a>
																	</div>
																	<div class="col-md-6 fv-row">
																	<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Tolak</button>
																	</div>
																</div>
                                                            </div> 
														</div>
