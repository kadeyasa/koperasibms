							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Laporan Pembayaran</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Laporan Pembayaran</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
                                                        ...
                                                        if($session->getFlashdata('error')):
                                                            ...
                                                            <div class="card">
                                                                    ...
                                                                    <div class="card-toolbar">
                                                                        ...
                                                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				...
																				<a href="<?php echo site_url('printlappembayaran?kolektor='.$kolektor.'&start='.$start.'&end='.$end);?>" class="btn btn-warning"><i class="bi bi-printer-fill" style="font-size:20px;"></i>Print</a>
																			</div>
																			<!--end::Input group-->
                                                                        </div>
                                                                        <!--end::Toolbar-->
                                                                ...
                                                                <div class="card-body pt-0">
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5">
																			...
																			<thead>
																				...
																				<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																					...
																					<th class="min-w-125px">Tgl Bayar</th>
																					<th class="min-w-125px">Jumlah Pokok</th>
																					<th class="min-w-125px">Jumlah Bunga</th>
                                                                                    <th class="min-w-125px">Total</th>
																					<th class="min-w-125px">Approve Status</th>
																					<th class="min-w-125px">Bukti Pembayaran</th>
																					<th class="min-w-125px">Di Input Oleh</th>
																			...
																			<tbody class="fw-semibold text-gray-600">
																				<?php 
                                                                                    ...
                                                                                    foreach($results as $row){
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo number_format($row->jumlah_pokok);?></td>
                                                                                            <td><?php echo number_format($row->jumlah_bunga);?></td>
                                                                                            <td><?php echo number_format($sub_total);?></td>
																							<td>
																								<?php
																									if($row->approve_status==0){ 
																								?>
																									<a href="javascript:approvestatus(<?php echo $row->id_pinjaman;?>);"><?php echo $approve_status;?></a>
																							...
																							<td><a href="<?php echo $row->bukti_pembayaran;?>" target="__blank"><?php echo $row->bukti_pembayaran;?></a></td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?php echo number_format($total_pokok);?></td>
                                                                                    <td><?php echo number_format($total_bunga);?></td>
																	...
																	<hr/>
																	<div class="table-responsive">
																	<h3>Data Pembayaran Dari Pencairan</h3>
																	<table class="table align-middle table-row-dashed fs-6 gy-5">
																			<!--begin::Table head-->
																			<thead>
																				<!--begin::Table row-->
																			...
																			<tbody class="fw-semibold text-gray-600">
																				<?php 
                                                                                    ...
                                                                                    $total_bunga =0;
                                                                                    $total=0;
                                                                                    foreach($results_pelunasan as $row){
                                                                                        $no++;
                                                                                        $sub_total=$row->jumlah_pokok+$row->jumlah_bunga;
                                                                                        $total_pokok = $total_pokok+$row->jumlah_pokok;
                                                                                        $total_bunga = $total_bunga+$row->jumlah_bunga;
