							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">DATA MODULE</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">User Module</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
                                                            ...
                                                            <div class="card">
																<div class="card-header border-0 pt-6">
																	<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																		<a href="javascript:tambah();" class="btn btn-success">User Module</a>
																	</div>
																</div>
																<!--begin::Card body-->
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5" id="data-tagihan">
																			...
																			<tbody class="fw-semibold text-gray-600">
																					...
																					foreach($results as $row){
																						$data = array();
                                                                                        $mo = explode(",",$row['modules']);	
                                                                                        $_m = $modulemodel->wherein('id',$mo)->select("name")->findAll();
                                                                                        foreach($_m as $m){
                                                                                            $data[]=$m['name'];
                                                                                        }
																					?>
																					<tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <a href="#" onclick="deletedata(<?php echo $row['id'];?>);" class="btn btn-danger">Delete</a>
																						</td>
																					</tr>
	...
	<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				<!--begin::Form-->
				<form class="form"  method="post" action="<?php echo site_url('saveusermodules');?>" id="kt_modal_add_customer_form" data-kt-redirect="">
					<!--begin::Modal header-->
					<div class="modal-header" id="kt_modal_add_customer_header">
						<!--begin::Modal title-->
						<h2 class="fw-bold">Tambah Module</h2>
						<!--end::Modal title-->
						<!--begin::Close-->
					...
					<div class="modal-body py-10 px-lg-17">
						...
						<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
							...
							<div class="form-group">
								<label>Modules</label>
								<select id="modules" name="modules[]" class="form-control" multiple="multiple" style="width:100%;">
                                    <option value=""></option>
                                    <?php 
                                        $parentmodules = getModuleParents();
                                        foreach($parentmodules as $module){   
                                            $childs = getModuleChilds($module['id']);                                
                                    ?>
