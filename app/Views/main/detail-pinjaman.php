                                                            ...
                                                            <div class="card">
																...
																<div class="row mb-5">
																	<div class="col-md-6 fv-row">
																		...
																		<input class="form-control form-control-solid" placeholder="" name="tgl_pengajuan" value="<?php echo $detail->tgl;?>" id="tgl_pengajuan" readonly/>
																	</div>
																	<div class="col-md-6 fv-row">
																...
																<div class="row mb-5">
                                                                    <div class="col-md-6 fv-row">
                                                                            <a href="<?php echo site_url('printpinjaman?id='.$id);?>" target="__blank" class="btn btn-warning btn-block btn-lg"><i class="bi bi-printer-fill" style="font-size:14px;"></i>Print </a>&nbsp;&nbsp;

																			<a href="<?php echo site_url('printkelengkapanpinjaman?id='.$id);?>" target="__blank" class="btn btn-warning btn-block btn-lg"><i class="bi bi-printer-fill" style="font-size:14px;"></i>Print Kelengkapan </a>
                                                                    </div>
                                                                </div>
                                                            </div> 
														</div>
