							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">DATA USER</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
                                                            ...
                                                            <div class="card">
																<div class="card-header border-0 pt-6">
																	<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																		<a href="javascript:tambah();" class="btn btn-success">Tambah User</a>
																	</div>
																</div>
																<hr/>
																<!--begin::Card body-->
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5" id="data-tagihan">
																			...
																			<thead>
																				...
																				<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																					...
																					<th class="min-w-125px">USERLEVEL</th>
                                                                                ...
                                                                                foreach($results as $row){
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <a href="javascript:deletedata(<?php echo $row['id'];?>);" class="btn btn-danger">Delete</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <?php
                                                                                }
	...
	<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				<!--begin::Form-->
				<form class="form"  method="post" action="<?php echo site_url('tambahuser');?>" id="kt_modal_add_customer_form" data-kt-redirect="">
					<!--begin::Modal header-->
						...
						<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
							...
							<div class="form-group">
								...
								<select name="userlevel" class="form-control" id="userlevel">
                                    ...
                                    <option value="3">Admin Kantor</option>      
