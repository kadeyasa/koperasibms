                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body pt-0">
																	<table>
                                                                        <tr>
                                                                            <td>Saldo Titipan</td>
                                                                            <td><?php echo number_format($saldo_titipan);?></td>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Jumlah Angsuran</td>
                                                                            <td></td>
                                                                            <td><?php echo number_format($jumlah_angsuran);?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Denda</td>
                                                                            <td></td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Saldo Titipan</td>
                                                                            <td></td>
                                                                            <td><?php echo number_format($saldo_titipan-$jumlah_angsuran-$denda);?></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                                <!--end::Card body-->
