                                                        ...
                                                        if($session->getFlashdata('error')):
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-header border-0 pt-6">
                                                                    ...
                                                                    <!--begin::Card title-->
                                                                    <!--begin::Card toolbar-->
																	<?php echo form_open('pengeluaran',array('method'=>'get'));?>
                                                                    <div class="card-toolbar">
                                                                        ...
                                                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				...
																				<a href="<?php echo site_url('printpengeluaran?&start='.$start.'&end='.$end);?>" class="btn btn-warning"><i class="bi bi-printer-fill" style="font-size:20px;"></i>Print</a>
																			</div>
			...
			<div class="modal-content">
				...
				<form class="form" action="<?php echo site_url('savependapatan');?>" id="kt_modal_add_customer_form" data-kt-redirect="<?php echo site_url('anggota');?>">
					...
					<div class="modal-header" id="kt_modal_add_customer_header">
						<!--begin::Modal title-->
						<h2 class="fw-bold">Tambah Pengeluaran</h2>
						<!--end::Modal title-->
						<!--begin::Close-->
					...
					<div class="modal-body py-10 px-lg-17">
						...
						<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fs-6 fw-semibold mb-2">Jenis Pengeluaran</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="false" data-placeholder="Pilih Jenis Pendapatan" data-kt-ecommerce-order-filter="status" name="jenis_pendapatan" id="jenis_pendapatan">
                                    <option value="02.01.210-100">Beli Materai</option>
                                    <option value="02.01.220-65">Pengeluaran Lain-lain</option>
                                </select>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
