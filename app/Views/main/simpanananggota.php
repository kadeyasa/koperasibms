...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Simpanan Anggota</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
                                                                ...
                                                                <div class="card-header border-0 pt-6">
                                                                    ...
                                                                    <div class="card-toolbar">
                                                                        ...
                                                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                                            ...
                                                                            <!--begin::Add customer-->
                                                                            <a type="button" class="btn btn-primary" href="<?php echo site_url('tambahsimpanananggota');?>"><i class="bi bi-cloud-plus" style="font-size:20px;"></i>TAMBAH</a>
																			&nbsp;
																			<a type="button" class="btn btn-primary" href="<?php echo site_url('addbungadeposito');?>"><i class="bi bi-cloud-plus" style="font-size:20px;"></i>BAGIKAN BUNGA TABUNGAN</a>
                                                                            <!--end::Add customer-->
                                                                        </div>
                                                                        <!--end::Toolbar-->
                                                                        <!--begin::Group actions-->
		...
		<script type="text/javascript">
			...
			"scrollX": true,
			"ajax":{
					url :"<?php echo site_url("datasimpanan"); ?>", // json datasource
