							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Pencairan</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Data pencairan</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
																				...
																				<?php 
																					foreach($list as $row){
																						...
																						<tr>
																							...
																							<td><?php echo $row->rek_pinjaman;?></td>
																							...
																							<td><?php echo '<a href="'.site_url('lihatdetailpinjaman?id='.$row->id).'" class="" title="Detail Pinjaman"><i class="bi bi-box-arrow-in-right" style="font-size:20px;"></i></a>&nbsp;&nbsp;<a href="'.site_url('setujuipencairan?id='.$row->id).'" class="" title="Setujui Pencairan"><i class="bi bi-check2-circle" style="font-size:20px;"></i></a>&nbsp;&nbsp;<a href="javascript:cancelpencairan('.$row->id.');" class="" title="Cancel Pencairan"><i class="bi bi-x-square-fill" style="font-size:20px;"></i></a>';?></td>
																						</tr>
																						<?php
																					}
																				?>
