                                                                        ...
                                                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				...
																				<div class="position-relative d-flex align-items-center w-150px">
																					<!--begin::Datepicker-->
																					<input id="kt_ecommerce_edit_order_date" name="dari_tgl" placeholder="Pilih Tanggal" class="form-control mb-2" value="" onchange=""/>
																					<!--end::Datepicker-->
																					<!--begin::Icon-->
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				...
																				<div class="position-relative d-flex align-items-center w-150px">
																					<!--begin::Datepicker-->
																					<input id="kt_ecommerce_edit_order_date2" name="sampai_tgl" placeholder="Pilih Tanggal" class="form-control mb-2" value="" onchange=""/>
																					<!--end::Datepicker-->
																					<!--begin::Icon-->
																					<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
																					<span class="svg-icon svg-icon-2 position-absolute ms-4 end-0">
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				...
																				<a href="<?php echo site_url('printtagihan');?>" class="btn btn-warning"><i class="bi bi-printer-fill" style="font-size:20px;"></i>Print</a>
																			</div>
																			<!--end::Input group-->
                                                                        </div>
                                                                        <!--end::Toolbar-->
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5">
																			...
																			<thead>
																				...
																				<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																					...
																					<th class="min-w-125px">Total Jatuh Tempo</th>
																					<th class="min-w-125px">Total Sisa Angsuran</th>
