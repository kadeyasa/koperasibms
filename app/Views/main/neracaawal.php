...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                                    ...
                                                                    <div class="card-toolbar">
                                                                        ...
                                                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                                            ...
                                                                            <div class="w-150px me-3">
                                                                                <!--begin::Select2-->
                                                                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Tahun Buku" onchange="changeyear(this.value);">
                                                                                    <?php 
                                                                                        $t_start = date('Y')-10;
                                                                                    ?>
                                                                                    <option></option>
                                                                            ...
                                                                            <!--end::Filter-->
                                                                            <!--begin::Export-->
                                                                            <a href="<?php echo site_url('printneracaawal?tahun='.$tahun);?>" class="btn btn-light-primary me-3" target="__blank">
                                                                            ...
                                                                            <!--end::Export-->
                                                                            <!--begin::Add customer-->
                                                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Tambah Neraca</button>
                                                                            <!--end::Add customer-->
                                                                        </div>
                                                                        <!--end::Toolbar-->
                                                                        <!--begin::Group actions-->
                                                                    ...
                                                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                                                        ...
                                                                        <thead>
                                                                            ...
                                                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                                ...
                                                                                <th class="min-w-125px">KODE AKUN</th>
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Sub Akun Dari" data-kt-ecommerce-order-filter="debet" id="debet" name="debet">
                                        
                                        <?php 
                                            foreach($akun_debet as $r){
                                                ?>
                                                <option value="<?php echo $r['no_akun'];?>">
                                                    <?php 
                                                        $padding='';
                                                        for($i=0;$i<$r['level_account'];$i++){
                                                            $padding.='&nbsp;&nbsp;';
                                                        }
                                                    ?>
                                                    <?php echo $padding;?>
                                                    <?php echo $r['no_akun'];?> 
                                                    <?php echo $r['account_name'];?></option>
                                                <?php
                                            }
                                        ?>
                                    </select>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Sub Akun Dari" data-kt-ecommerce-order-filter="saldo normal" id="kredit" name="kredit">
                                        
                                        <?php 
                                            foreach($akun_kredit as $r){
                                                ?>
                                                <option value="<?php echo $r['no_akun'];?>">
                                                    <?php 
                                                        $padding='';
		...
		<?php 
            include('footer.php');
        ?>
		<script src="assets/js/custom/apps/ecommerce/customers/listing/listing-neraca.js"></script>
