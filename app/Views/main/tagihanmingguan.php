                                                                    ...
                                                                    <div class="card-toolbar">
                                                                        ...
                                                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				<a href="<?php echo site_url('printtagihanmingguan');?>" class="btn btn-warning"><i class="bi bi-printer-fill" style="font-size:20px;"></i>Print</a>
																			</div>
																			<!--end::Input group-->
                                                                        </div>
                                                                        <!--end::Toolbar-->
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5">
																			...
																			<thead>
																				...
																				<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                                    ...
                                                                                    <th class="min-w-125px">Hasil Followup</th>
																				...
																				<?php 
                                                                                    ...
                                                                                    foreach($results as $row){
																						...
																						<tr>
																							...
																							<td><?php echo $row->totaltunggakan;?></td>
                                                                            ...
                                                                            <tfoot>
                                                                                <tr>
                                                                                    <td colspan="10"><?php echo $pager_links;?></td>
                                                                                </tr>
                                                                            </tfoot>
																		</table>
																		<!--end::Table-->
