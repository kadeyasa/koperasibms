...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Simpanan Pokok</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Simpanan Pokok</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
                                                                    ...
                                                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                                                        ...
                                                                        <thead>
                                                                            ...
                                                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                                ...
                                                                                <th class="min-w-125px">Tgl Transaksi</th>
                                                                        ...
                                                                        <tbody class="fw-semibold text-gray-600">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <!--begin::Name=-->
                                                                                <td>
                                                                                    <?php echo number_format($row->kredit);?>
                                                                                </td>
                                                                                <!--end::Name=-->
                                                                                <!--begin::Status=-->
                                                                                <td>
                                                                                    <?php echo $row->status?'Sukses':'Pending';?>
                                                                                </td>
                                                                                <!--begin::Action=-->
                                                                                <td class="text-end">
                                                                                    ...
                                                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                                                        ...
                                                                                        <!--begin::Menu item-->
                                                                                        <div class="menu-item px-3">
                                                                                            <a href="javascript:deletesimpananpokok('<?php echo $row->id_transaksi;?>');" class="menu-link px-3">Delete</a>
                                                                                        </div>
                                                                                        <!--end::Menu item-->
                                                                                    </div>
                                                                                    <!--end::Menu-->
                ...
                <div class="modal-content">
                    ...
                    <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="<?php echo site_url('anggota');?>">
                        ...
                        <div class="modal-header" id="kt_modal_add_customer_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold">Tambah Simpanan Pokok</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="anggota" id="anggota" aria-label="Anggota" data-control="select2" data-placeholder="Pilih Anggota" class="form-select form-select-solid">
                                        <option></option>
                                        <?php 
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required form-label">Tgl Transaksi</label>
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <input id="kt_ecommerce_edit_order_date" name="tgl_transaksi" placeholder="Pilih Tanggal" class="form-control mb-2" value=""/>
                                    <!--end::Editor-->
        ...
        <script src="assets/js/custom/apps/ecommerce/customers/listing/add-simpananpokok.js"></script>
