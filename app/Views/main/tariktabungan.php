...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Tarik Bunga Tabungan</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Tarik Bunga Tabungan</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
                                                        ...
                                                        if($session->getFlashdata('error')):
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body pt-0">
																	<?php echo form_open('tariktabungan?id='.$id_anggota,array('method'=>'post'));?>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input  name="jumlah" id="jumlah" type="number" placeholder="Jumlah Penarikan" class="form-control mb-2" value="" onchange=""/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>Saldo</label>
                                                                                    <input  name="saldo" id="saldo" placeholder="" class="form-control mb-2" value="<?php echo number_format($datatabungan->total);?>" onchange=""/>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    
                                                                                    <button class="btn btn-primary" name="submit" style="margin-top:20px;">Simpan</button>
                                                                                </div>
                                                                            </div>
                                                                        <div>
                                                                    <?php echo form_close();?>
        ...
        <script src="assets/js/custom/apps/ecommerce/customers/listing/add-pengeluaran.js"></script>
