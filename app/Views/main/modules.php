                                                            ...
                                                            <div class="card">
																<div class="card-header border-0 pt-6">
																	<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																		<a href="javascript:tambah();" class="btn btn-success">Tambah Module</a>
																	</div>
																</div>
																<hr/>
																<!--begin::Card body-->
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5" id="data-tagihan">
																			...
																			<thead>
																				...
																				<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																					...
																					<th class="min-w-125px">NAMA MODULE</th>
																			...
																			<tbody class="fw-semibold text-gray-600">
																					...
																					foreach($results as $row){	
																						$childs = $model->where('parent',$row['id'])->findAll();
																					?>
																					<tr>
																						...
																						<td>
																							<?php echo $row['name'];?> [ <?php echo '<a href="'.base_url().'/'.$row['link'].'">'.base_url().'/'.$row['link'].'</a>';?> ]
																							<?php if($childs){
																								foreach($childs as $child){
																									echo ' <br/>'. $child['name'].' [ <a href="'.base_url().'/'.$child['link'].'">'.base_url().'/'.$child['link'].'</a> ]';
																								}
																							}?>
																						</td>
																					</tr>
	...
	<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				<!--begin::Form-->
				<form class="form"  method="post" action="<?php echo site_url('tambahmodule');?>" id="kt_modal_add_customer_form" data-kt-redirect="">
					<!--begin::Modal header-->
					...
					<div class="modal-body py-10 px-lg-17">
						...
						<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
							...
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control" id="nama_module">
							</div>
							<div class="form-group">
								<label>Link</label>
					...
					<div class="modal-footer flex-center">
						...
						<!--end::Button-->
						<!--begin::Button-->
						<button type="submit" class="btn btn-primary" onclick="return submit_data();">
