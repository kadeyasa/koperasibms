							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Jurnal</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
                                                        ...
                                                        if($session->getFlashdata('error')):
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-header border-0 pt-6">
                                                                    ...
                                                                    <!--begin::Card title-->
                                                                    <!--begin::Card toolbar-->
																	<?php echo form_open('jurnalumum',array('method'=>'get'));?>
                                                                        ...
                                                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				...
																				<div class="w-150px me-3">
																					<!--begin::Select2-->
																					<select class="form-select form-select-solid" data-control="select2" data-hide-search="false" data-placeholder="Pilih Akun" data-kt-ecommerce-order-filter="status" name="account">
																						<option></option>
																						<?php foreach($data_akun as $akun){?>
																							<option value="<?php echo $akun['id'];?>"><?php echo $akun['no_akun'];?> - <?php echo $akun['account_name'];?></option>
																						<?php }?>
																					</select>
																					<!--end::Select2-->
																				</div>
																			...
																			<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
																				...
																				<a href="<?php echo site_url('printjurnal?account='.$account.'&start='.$start.'&end='.$end);?>" class="btn btn-warning"><i class="bi bi-printer-fill" style="font-size:20px;"></i>Print</a>
																			</div>
																			<!--end::Input group-->
                                                                        </div>
                                                                        <!--end::Toolbar-->
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5">
																			...
																			<tbody class="fw-semibold text-gray-600">
																				...
																				<tr>
																					...
																					<td><?php echo number_format($total_debet);?></td>
																					<td><?php echo number_format($total_kredit);?></td>
																				</tr>
																			</tbody>
																			<!--end::Table body-->
																		</table>
