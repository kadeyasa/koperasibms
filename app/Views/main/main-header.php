                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5"><?php echo session('username');?>
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?php echo session('level');?></span></div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?php echo session('user_email');?></a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
