    ...
    <table width="100%" align="center" style="border:1px solid #ccc;" cellpadding="5" cellspacing="0">
																			...
																			<thead>
																				...
																				<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                                    ...
                                                                                    <th class="min-w-125px" style="font-family:arial; border:1px solid #000; font-size:11px;">Tgl Jatuh Tempo</th>
																					...
																					<th class="min-w-125px" style="font-family:arial; border:1px solid #000; font-size:11px;">Fllow Up</th>
																				</tr>
																				<!--end::Table row-->
																			</thead>
																			<!--end::Table head-->
																			...
																			<tbody class="fw-semibold text-gray-600">
																				<?php 
                                                                                    ...
                                                                                    foreach($results as $row){
																						...
																						$no++;
																						$sisa_angsuran = ($row->jumlah_pokok+$row->jumlah_bunga)*$row->total_tunggakan;
																						if($row->total_tunggakan>=3){
																							$bg='red';
																						}else{
																							$bg='white';
																						}
																						...
																						<tr style="background-color:<?php echo $bg;?>;print-color-adjust: exact;">
                                                                                            ...
                                                                                            <td valign="center" align="left" style="background-color:<?php echo $bg;?>;font-family:arial; border:1px solid #000; font-size:11px;"><?php echo $row->tgl_jatuh_tempo;?></td>
																							...
																							<td align="center"  style="background-color:<?php echo $bg;?>;font-family:arial; border:1px solid #000; font-size:11px;"><?php echo $row->total_tunggakan;?></td>
																							<td align="center"  style="background-color:<?php echo $bg;?>;font-family:arial; border:1px solid #000; font-size:11px;"><?php echo json_encode($m->_restjanji($_fs,$row->id_anggota));?></td>
																						</tr>
																						<?php
