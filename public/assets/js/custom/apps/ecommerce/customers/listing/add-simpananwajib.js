                    ...
                    e.preventDefault(),
                        n &&
                            n.validate().then(function (e) {
                                ...
                                var tgl_transaksi = $('#kt_ecommerce_edit_order_date').val();
                                ...
                                console.log("validated!"),
                                    "Valid" == e
                                        ? (t.setAttribute("data-kt-indicator", "on"),
                                          ...
                                          setTimeout(function () {
                                            $.ajax({
                                                url:'savesimpananwajib',
                                                type:'post',
                                                data:{id_anggota:anggota,tgl_transaksi:tgl_transaksi,debet:jumlah,status:1,id:id},
