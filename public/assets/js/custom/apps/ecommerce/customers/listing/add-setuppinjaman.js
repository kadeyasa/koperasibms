                                ...
                                console.log("validated!"),
                                    "Valid" == e
                                        ? (t.setAttribute("data-kt-indicator", "on"),
                                          ...
                                          setTimeout(function () {
                                            $.ajax({
                                                url:'savesetuppinjaman',
                                                type:'post',
                                                data:{nama_simpanan:nama_simpanan,jangka_waktu:jangka_waktu,bunga_pinjaman:bunga_pinjaman,status:status,jenis_pinjaman:jenis_pinjaman,id:id},
