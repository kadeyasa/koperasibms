...
function editakun(id){
    ...
    $.ajax({
        ...
        success:function(response){
            var data = JSON.parse(response);
            $('#no_akun').val(data.message.no_akun);
            $('#saldo_normal').val(data.message.saldo_normal);
            $('#level_account').val(data.message.level_account);
            $('#account_name').val(data.message.account_name);
            $('#sub_akun').val(data.message.sub_account);
            $('#id_data').val(id);
        }
    });
}
...
function changetahuntagihan(tahun){
    var bulan_data = $('#bulan_data').val();
    location.href='/tagihansimpananwajib?tahun='+tahun+'&bulan='+bulan_data;
}

function changebulantagihan(bulan){
    var tahun_data = $('#tahun_data').val();
    location.href='/tagihansimpananwajib?tahun='+tahun_data+'&bulan='+bulan;
}
