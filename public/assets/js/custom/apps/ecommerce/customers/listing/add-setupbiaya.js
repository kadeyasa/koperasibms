                                ...
                                console.log("validated!"),
                                    "Valid" == e
                                        ? (t.setAttribute("data-kt-indicator", "on"),
                                          ...
                                          setTimeout(function () {
                                            $.ajax({
                                                url:'savebiayapinjaman',
                                                type:'post',
                                                data:{nama_biaya:nama_biaya,jenis_biaya:jenis_biaya,jumlah:jumlah,status:status,jenis_pinjaman:jenis_pinjaman,id:id,akun:akun},
