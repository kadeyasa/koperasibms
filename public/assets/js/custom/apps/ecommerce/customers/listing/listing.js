...
function editmember(id){
    ...
    $.ajax({
        ...
        success:function(response){
            var data = JSON.parse(response);
            $('#no_anggota').val(data.message.no_anggota);
            $('#nik').val(data.message.nik);
            $('#nama').val(data.message.nama);
            $('#jenis_kelamin').val(data.message.jenis_kelamin);
            $('#email').val(data.message.email);
            $('#no_telp').val(data.message.no_telp);
            $('#alamat').val(data.message.alamat);
            $('#photo').val(data.message.photo_ktp);
            $('#koordinat').val(data.message.koordinat);
            $('#id_data').val(id);
        }
    });
}
